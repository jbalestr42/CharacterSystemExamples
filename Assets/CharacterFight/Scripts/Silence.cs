...
public class Silence : ASkill {
	...
	public override void Cast(GameObject p_owner) {
        ...
        DurationModifier.Params<bool> attribute = new DurationModifier.Params<bool>();
        ...
        target.GetComponent<AttributeManager>().AddModifier(Factory.GetModifier(AttributModifierType.Duration, target, attribute));
	}
}
